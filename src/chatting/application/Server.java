...
import java.net.*;
import java.io.*;
public class Server  implements ActionListener { //Server is a public class .To build Frame we need a class called JFrame class and it is present under Swing package   
    ...
    JPanel a1; // declearing the the panel "a1" globally 
    ...
    Server(){
       ...
       /*-------------------------------------Phone Icon------------------------------------------------------------*/
        ...
        f.setLocation(200,50); //by defult the frame get open at origin (top-left corner). By sing setLocation() function we can define the coordinates  of the frame where shich we want to disply the frame
